...
/**
 * 本类是Activity生命周期监听器.在{@link ApplicationMostBasic}中注册了该监听器.
 * 监听了所有的Activity生命周期,以便在application中提供current activity.如果activity实现了{@link IView},
 * 且持有的presenter不未null,则绑定activity生命周期至持有的presenter.如果activity派生至FragmentActivity,
 * 且实现了{@link IActivity}接口,且IActivity方法hasFragment()返回true,则监听fragment生命周
 * 期{@link FragmentLifecycleBindCallbacks}.
 * <p>
 * Created by Az
 * on 2019/2/22.
 */
